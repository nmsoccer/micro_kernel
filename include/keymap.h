...
/*
 *each key scan code may have relation to three different forms
 *focus on base scan code
 */

#include "keyboard.h"

u8 keymap[NUM_SCAN_CODES * NUM_FORMS] = {
...
//在此键盘上，UP与PAD_UP的扫描码一样，即，UP没有0xE0的前缀
